...
const STRINGS = {
  en: {
    ...
    tradeTrackerScopeLeagueAll: (n) => `All ${n} league trade${n === 1 ? "" : "s"} on record`,
    tradeTrackerScopeTeamAll: (name, n) => `All ${n} trade${n === 1 ? "" : "s"} for ${name}`,
    tradeTrackerSearchLabel: "Look up a manager's trades",
    tradeTrackerSearchPlaceholder: "— All managers —",
  ...
  es: {
    ...
    tradeTrackerScopeLeagueAll: (n) => `Los ${n} trade${n === 1 ? "" : "s"} registrados en la liga`,
    tradeTrackerScopeTeamAll: (name, n) => `${n === 1 ? "El único trade" : `Los ${n} trades`} de ${name}`,
    tradeTrackerSearchLabel: "Buscar los trades de un manager",
    tradeTrackerSearchPlaceholder: "— Todos los managers —",
