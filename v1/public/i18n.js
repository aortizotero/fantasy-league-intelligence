...
const STRINGS = {
  en: {
    ...
    usernameLookupToggle: "Or find your leagues by Sleeper username",
    usernameLabel: "Sleeper username",
    usernamePlaceholder: "Sleeper username",
    findLeaguesBtn: "Find My Leagues",
    findingLeagues: "Finding leagues...",
    usernameLookupPickHint: "Pick a league:",
    loading: "Loading...",
  ...
  es: {
    ...
    usernameLookupToggle: "O busca tus ligas por tu usuario de Sleeper",
    usernameLabel: "Usuario de Sleeper",
    usernamePlaceholder: "Usuario de Sleeper",
    findLeaguesBtn: "Buscar Mis Ligas",
    findingLeagues: "Buscando ligas...",
    usernameLookupPickHint: "Elige una liga:",
    loading: "Cargando...",
